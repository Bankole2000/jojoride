...
require_once '../../vendor/autoload.php';
  ...
  if(isset($_POST["action"]))
  {
    ...
    if($_POST["action"] == "signup")
    {
      ...
      $mail->Body = '<p>Welcome to '.$bizname.'.</p><br> 
      <p>Hello '.$username.', Welcome to '.$bizname.' and Congratulations on Signing up. Here are your Login Details:</P> 
      <p>Username: '.$userusername.'.</p> 
      <p>Email:  '.$usermail.'.</p> 
      <p>Password: '.$password.'.</p>
      <p>Verification Code: '.$code.'</p> 
      <p>Please Enter the verification code to verify your email. Congratulations again and Welcome to '.$bizname.'.</p> 
      
      <p>You got this mail because we think you tried to sign up on www.'.$bizname.'.com. If you think we made a mistake, just ignore this message.</p>';
